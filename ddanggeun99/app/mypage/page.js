        ...
        <div className="p-3">
          <div className="flex justify-between items-center ml-1">
            {userData && userData.nickname && userData.user_image && (
              <>
                ...
                ></img>
                <div className="mr-[470px] text-xl ml-2">
                  {userData.nickname}
                </div>
              </>
            )}
            <button
              ...
              className="rounded-md w-28 h-8 bg-slate-300"
            >
              프로필 보기
            </button>
          </div>
          ...
          <div className="p-3  border rounded-lg border-dashed border-orange-500 mt-6 mb-10">
            <div className="flex justify-between items-center">
              <img
                className="w-[100px]"
                src="https://img.etnews.com/photonews/2111/1469640_20211102084651_398_0001.jpg"
              ></img>
              <div className="mr-4 flex items-center">
                당근하는 새로운 방법, 당근페이!
                <MdOutlineNavigateNext className="ml-2" size={"25px"} />
              </div>
            </div>
            <div className="flex justify-between items-center">
              <button className="bg-gray-200 w-[350px] rounded-lg  h-10">
                충전
              </button>
              <button className="bg-gray-200 w-[350px] rounded-lg  h-10">
                계좌송금
